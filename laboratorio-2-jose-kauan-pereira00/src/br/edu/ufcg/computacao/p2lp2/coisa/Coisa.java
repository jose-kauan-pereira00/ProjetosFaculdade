...
/**
 * Controle Institucional da Situação Acadêmica (CoISA), Sistema capaz de gerenciar
 * o uso dos laboratórios de Ciência da Computação (LCC’s) e sua vida acadêmica
 * 
